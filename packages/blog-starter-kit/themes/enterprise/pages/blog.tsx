	...
	return (
		<AppProvider publication={publication}>
			<Layout>
				<Head>
					<title>
						{ 'Safeer C M' || publication.displayTitle || publication.title || 'Hashnode Blog Starter Kit'}
					</title>
					<meta
						name="description"
						content={
							'Safeer C M' || publication.descriptionSEO || publication.title || `${publication.author.name}'s Blog`
						}
					/>
